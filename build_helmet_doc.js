...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      rtl('סכימת הספירה: 291 בתיקים + 15 מלאי ימ"ח + 59 מחוץ לימ"ח = 365 יח\'. יצוין כי בדיווח קודם צוין סך של 361 יח\' — הפרש של 4 יח\' לווידוא.', { numbering: { reference: 'bullets', level: 0 } }),
