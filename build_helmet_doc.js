...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      rtl('בתאריך 6.1.2026 בוצעה ספירת תיקים בימ"ח. במסגרת הספירה נספרו 291 קסדות בימ"ח, ובנוסף ביצע הגדוד וידוא לקסדות הנמצאות מחוץ לימ"ח, בפילוח הבא:'),
      table([3500, 3000], [
      ...
      table([5500, 2500], [
        ...
        ['נספרו בימ"ח (6.1.2026)', '291'],
        ['מאומתות מחוץ לימ"ח (פלוגות)', '59'],
        [{ text: 'סה"כ קסדות שנספרו ומיקומן ידוע', bold: true }, { text: '361', bold: true }],
        [{ text: 'פער — קסדות שמיקומן טרם אומת', bold: true }, { text: '37', bold: true, color: RED }],
      ]),
      rtl('', { spacing: { after: 60 } }),
      ...
      rtl('סכימת הספירה (291 בימ"ח + 59 מחוץ לימ"ח) מסתכמת ב-350 יח\', בעוד שסך הקסדות הידועות דווח כ-361 יח\'. נדרש וידוא של 11 היח\' המהוות את ההפרש.', { numbering: { reference: 'bullets', level: 0 } }),
      rtl('נדרש להמשיך באיתור 37 היח\' שמיקומן טרם אומת (398 שהתקבלו מול 361 ידועות).', { numbering: { reference: 'bullets', level: 0 } }),
    ],
  }],
});
